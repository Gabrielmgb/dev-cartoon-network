    ...
    <div className="bg-blue-50 min-h-screen font-sans flex flex-col">
      ...
      <main className="flex-grow">
        ...
        <section className="relative bg-gradient-to-b from-sky-300 to-green-300 text-white py-20 text-center">
          <div className="container mx-auto px-4">
            ...
            <p className="mt-4 text-lg max-w-3xl mx-auto">
              Junte-se aos seus personagens favoritos para proteger nosso planeta. Pequenas ações criam um futuro
              gigante!
            </p>
          </div>
        </section>
        ...
        <section className="container mx-auto px-4 py-16">
          <h2 className="text-3xl font-bold text-center mb-10">Dicas para Salvar o Planeta</h2>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {climateTips.map((tip) => (
              <Card key={tip.title} className="text-center border-2 border-green-200 hover:shadow-xl transition-shadow">
          ...
          <div className="text-center mt-12">
            <Button size="lg" className="bg-green-500 hover:bg-green-600 text-lg font-bold">
